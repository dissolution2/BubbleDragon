...
public class NavigationDrawer extends Table {
    ...
    private boolean enableDrag = false;//true;
...
*/
    ...
    private void updatePosition() {
        ...
        this.setPosition( clamp.x, 1, Align.bottomRight);
    }
    ...
    private boolean isFadeBackground = false; // false
